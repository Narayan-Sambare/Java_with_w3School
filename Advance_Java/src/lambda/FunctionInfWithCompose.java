...
public class FunctionInfWithCompose {
...
//			}
//		};
//		Function<Integer, Integer> r=f1.compose(f2);
...
//		Function<Integer,Integer> f1=(Integer t)->t/2;
//		Function<Integer,Integer> f2=(Integer t) ->t*t;
//		System.out.println(((Function<Integer, Integer>)f1.compose(f2)).apply(15));

		
//		System.out.println(((Function<Integer,Integer>)((Function<Integer,Integer>)(Integer t)->t/2).compose((Function<Integer,Integer>)(Integer t)->t*t)).apply(15));
