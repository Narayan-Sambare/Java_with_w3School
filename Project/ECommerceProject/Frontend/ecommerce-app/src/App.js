...
const handleLogin = (e) => {
  ...
  setCurrentPage(user.userType === "customer" ? "shop" : "dashboard");
  setUsername("");
  setPassword("");
};
...
const ECommerceApp = () => {
  ...
  const [registeredUsers, setRegisteredUsers] = useState([
    { username: 'user1', password: 'pass123', email: 'user1@email.com', userType: 'customer', phone: '9876543210', address: 'Mumbai' },
    { username: 'admin1', password: 'pass123', email: 'admin@email.com', userType: 'admin', phone: '9876543211', address: 'Delhi' },
    { username: 'manager1', password: 'pass123', email: 'manager@email.com', userType: 'manager', phone: '9876543212', address: 'Pune' },
    { username: 'emp1', password: 'pass123', email: 'emp@email.com', userType: 'employee', phone: '9876543213', address: 'Bangalore' },
  ]);
      ...
      <div className="bg-white rounded-lg shadow-2xl p-8 max-w-md w-full">
        ...
        {currentPage === 'login' ? (
          <>
            ...
            <p className="text-center text-gray-600 mt-4 text-xs border-t pt-4">
              <strong>Demo Accounts:</strong><br/>
              user1 / pass123 (Customer)<br/>
              admin1 / pass123 (Admin)<br/>
              manager1 / pass123 (Manager)<br/>
          ...
          <>
            ...
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg transition duration-200 mt-4"
            >
              Register
            </button>
